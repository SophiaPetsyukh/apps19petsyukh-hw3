...
//                func);
    ...
    public static String[]
        ...
        SmartArray smartArr = new BaseArray(students);
        smartArr = new FilterDecorator(smartArr, pr);
        smartArr = new SortDecorator(smartArr, comp);
        smartArr = new MapDecorator(smartArr, myfunc);
        smartArr = new DistinctDecorator(smartArr);

        Object[] result = smartArr.toArray();
        return Arrays.copyOf(result, result.length, String[].class);
    }
}
